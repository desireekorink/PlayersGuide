...
public class SimulasSoup {
    ...
    public static void main(String[] args) {
        ...
        while (cooking) {
            ...
            System.out.println("\nNow that we know what we are going to eat, what will be the main ingredient?" + mushrooms + ", " + chicken + ", " + carrots + "or " + potatoes + "?");
            ...
            System.out.println("Want to cook something else?");
            String chooseContinue = input.nextLine().toLowerCase();
            if (chooseContinue.equals("no")) {
                cooking = false;
            }
        }
